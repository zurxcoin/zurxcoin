...
const char * const BITCOIN_CONF_FILENAME = "zurxcoin.conf";
const char * const BITCOIN_PID_FILENAME = "zurxcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Zurxcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Zurxcoin";
#else
    // Unix
    return pathRet / ".zurxcoin";
#endif
#endif
}
