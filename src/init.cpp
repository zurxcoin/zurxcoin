...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/zurxcoin/zurxcoin>";
    const std::string URL_WEBSITE = "<https://zurxcoin.com>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    connman.AddNode("seed1.zurxcoin.com");
    connman.AddNode("seed2.zurxcoin.com");
