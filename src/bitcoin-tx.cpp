...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s zurxcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zurxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zurxcoin transaction") + "\n" +
              "  zurxcoin-tx [options] -create [commands]   " + _("Create hex-encoded zurxcoin transaction") + "\n" +
              "\n";
